                               ...
                               <?php if( 'quote' !== $post_format && auxin_is_true(  $show_info ) ) { ?>
                                ...
                                <div class="entry-content">
                                    ...
                                    if( 'link' == $post_format ) {
                                        ...
                                        $content_listing_type   = is_category() || is_tag() || is_tax() ? auxin_get_option( 'post_taxonomy_archive_content_on_listing' ) : auxin_get_option( 'blog_content_on_listing' );
                                        $content_listing_length = is_category() || is_tag() || is_tax() ? auxin_get_option( 'post_taxonomy_archive_on_listing_length', 255 ) : auxin_get_option( 'excerpt_len', 255 );
